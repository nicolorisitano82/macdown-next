...
| Server MCP con perimetro | **fatto** — quattro fasi, pannello compreso | master | — |
...
finisce in `~/Library/Logs/MacDown Next/mcp.log`, che si legge in
**Impostazioni ▸ Agenti** insieme alla riga da incollare nel client — e lì
c'è anche l'interruttore che spegne tutto: spento, il server non parte.
